...
def append_call(args):
    fio.append_to_out(f"CAL {args[1]}")
...
def main():
    ...
    fio.create_out_file()
    fio.append_to_out("// Made by olvior in a (slightly) higher level language")
    fio.append_to_out("// Translated into asm by a python script")
